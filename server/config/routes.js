...
module.exports = function (app) {
  ...
  app.get('/api/users/:username', users.load, users.show);
  app.put('/api/users/:username', users.load, requires.self, users.update);
  app.delete('/api/users/:username', users.load, requires.self, users.destroy);
  app.post('/api/users/:username/images', users.load, requires.self, users.images.create);
  app.delete('/api/users/:username/images', users.load, requires.self, users.images.destroy);
